...
class MyBot(object):
    ...
    def diffuse_food(self, ants):
        ...
        diff_loss = 1 - MyBot.DIFF_FACTOR * adj_field
        diff_n = MyBot.DIFF_FACTOR * unblocked_n
        diff_s = MyBot.DIFF_FACTOR * unblocked_s
        diff_w = MyBot.DIFF_FACTOR * unblocked_w
        diff_e = MyBot.DIFF_FACTOR * unblocked_e
