...
class MyBot(object):
    ...
    def do_turn(self, ants):
        ...
        if Settings.VISUALIZE and 123 < ants.cur_turn < 125:
    ...
    def diffuse_food(self, ants):
        ...
        for cell in ants.world_list:
            if cell.terrain is WATER:
                # WATER: do not receive diffusion
    ...
    def diffuse_explore(self, ants):
        ...
        scent_field = invisible.astype(np.float64) # initialize with 1's
